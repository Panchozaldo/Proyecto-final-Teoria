...
void CFiguras::prisma31(float altura, float largo, float profundidad, GLuint text)  //Funcion creacion prisma
{
...
void CFiguras::prisma22(float altura, float largo, float profundidad, GLuint text)  //Funcion creacion prisma
{
	...
	glTexCoord2f(2.0f, 2.0f); glVertex3fv(vertice[7]);
	...
	glTexCoord2f(2.0f, 2.0f); glVertex3fv(vertice[5]);
	glTexCoord2f(0.0f, 2.0f); glVertex3fv(vertice[4]);
	glEnd();
	...
	glBegin(GL_POLYGON);	//Back
		//glColor3f(0.0,1.0,0.0);
	glNormal3f(0.0f, 0.0f, -1.0f);
	glTexCoord2f(0.0f, 2.0f); glVertex3fv(vertice[6]);
	glTexCoord2f(2.0f, 2.0f); glVertex3fv(vertice[5]);
	glTexCoord2f(2.0f, 0.0f); glVertex3fv(vertice[3]);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[2]);
	glEnd();
	...
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[0]);
	glTexCoord2f(2.0f, 0.0f); glVertex3fv(vertice[1]);
	glTexCoord2f(2.0f, 2.0f); glVertex3fv(vertice[2]);
...
void CFiguras::prisma32(float altura, float largo, float profundidad, GLuint text)  //Funcion creacion prisma
{
	...
	glNormal3f(0.0f, 0.0f, -1.0f);
	glTexCoord2f(0.0f, 1.0f); glVertex3fv(vertice[6]);
	glTexCoord2f(3.0f, 2.0f); glVertex3fv(vertice[5]);
	glTexCoord2f(3.0f, 0.0f); glVertex3fv(vertice[3]);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[2]);
	glEnd();
	...
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[0]);
	glTexCoord2f(3.0f, 0.0f); glVertex3fv(vertice[1]);
	glTexCoord2f(3.0f, 2.0f); glVertex3fv(vertice[2]);
	glTexCoord2f(0.0f, 2.0f); glVertex3fv(vertice[3]);
	glEnd();
	...
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[4]);
	glTexCoord2f(3.0f, 0.0f); glVertex3fv(vertice[5]);
	glTexCoord2f(3.0f, 2.0f); glVertex3fv(vertice[6]);
	glTexCoord2f(0.0f, 2.0f); glVertex3fv(vertice[7]);
	glEnd();
}
