...
public:
	...
	void prisma22(float altura, float largo, float profundidad, GLuint text);//Funcíon creacion prisma
	void prisma32(float altura, float largo, float profundidad, GLuint text);//Funcíon creacion prisma
	void prisma31(float altura, float largo, float profundidad, GLuint text);//Funcíon creacion prisma
